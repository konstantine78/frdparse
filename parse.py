...
with open('/Users/kostas/MyPythonProjects/frdexports/exporttextfiles/IOExportFile.txt', 'r') as f:
    with open('/Users/kostas/MyPythonProjects/frdexports/exporttextfiles/IOExportFileCleanedUp.txt', 'r+') as wf:
        f_content = f.readlines()
        for line in f_content:
            if re.search('\S', line):  
                wf.write(line)
        f_content = wf.readlines()
